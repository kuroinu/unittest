...
public class CalcuratorTest {
	...
	public static class caluculateで文字列を評価する場合 {
		...
		public static Fixture[] DATAS = { //new Fixture("1+1", "2"),
			...
			new Fixture("2+(2a1a3s2)+3", "9"),
			new Fixture("2+(M2a1)", "1"),
			new Fixture("2+(M2a1)×2", "0"),
			new Fixture("2+(M2sM2)×2", "2"),
			new Fixture("2+(2s1)×M3", "-1"),
			new Fixture("L2", "0.6931471805599453"),
			new Fixture("√2", "1.4142135623730951"),
				 };
