...
public class FizzBuzzTest {
	...
	public static class getFizzBuzzRandomNumberメソッドでランダム数のジェネレータを指定した場合 {
		...
		@DataPoint
		public static Fixture Buzzの組み合わせが正しいこと = new Fixture(5, "Buzz");
		@DataPoint
		public static Fixture FizzBuzzの組み合わせが正しいこと = new Fixture(15, "FizzBuzz");
		@DataPoint
		public static Fixture FizzBuzzに当てはまらない組み合わせが正しいこと = new Fixture(2, "2");
